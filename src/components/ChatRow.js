...
const  ChatRow = ({matchDetails}) => {
    ...
    useEffect(
        ()=>
        firestore().collection('users').where('id','==',otherUser).onSnapshot(
          (snapshot)=>setmatchedUserInfo(
    ...
    navigation.navigate('Messages1',{
        ...
        <Image
        style = {{borderRadius :100,height:40,width:40,marginRight:14,marginLeft:6}}
        // source={{uri: matchedUserInfo?.photoURL}}
        source = {{uri:matchedUserInfo[0].photoURL}}
        />
